...
const fieldSets = {
  ...
  organization: {
    label: "Managed-property palm portfolio inquiry",
    event: "organization-inquiry-delivered",
    required: ["contact_name", "email", "organization", "role", "property_or_service_area", "desired_service", "support_requested"],
    fields: [
      ...
      ["Known palm species", "known_palm_species"],
      ["Existing landscape or tree contractor", "existing_contractor"],
