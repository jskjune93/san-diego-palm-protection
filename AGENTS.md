...
- Use this synchronized public statement sitewide: “California Pest Control Business License No. 47756 · California Qualified Applicator License No. 175295 · Category B — Landscape Maintenance · Insured.” Wherever the QAL is listed publicly, list the Pest Control Business License with it. Do not imply that the QAL alone authorizes business operation. State that SDPP provides assessment, monitoring, documentation, preventive protection, pesticide treatment when appropriate, fertilization and palm-health stewardship, decline response, and contractor coordination. Keep this wording synchronized through `site-config/business_status.json` and the centralized credential component.
