...
- In prelicense mode, do not advertise, solicit, quote, book, accept deposits for, or imply current pesticide applications. John Krause's verified individual California QAL No. 175295, Category B — Landscape Maintenance, and SDPP's insured status may be displayed only through `site-config/business_status.json` and the centralized credential component. Never present QAL No. 175295 as a Pest Control Business License or as business-level pesticide authorization.
