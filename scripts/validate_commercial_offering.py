...
def main() -> int:
    ...
    for phrase in ("SAPW prevention and licensed palm treatment", "Assessments &amp; baselines", "Recurring palm care", "Decline, recovery &amp; transplant care", "Palm Portfolio Baseline", "Annual Palm Stewardship Program", "View Commercial Overview", "Download Commercial Overview"):
