...
async function main() {
  ...
  const requiredByPage = {
    ...
    "managed-property-palm-services.html": ["Palm Portfolio Stewardship for Managed Properties", "Our goal is to preserve the value of your mature landscape assets.", "Why SDPP", "What we do", "Palm Portfolio Baseline", "Annual Palm Stewardship Program", "data-engagement-path=\"palm-portfolio-baseline\"", "data-engagement-path=\"annual-palm-stewardship-program\"", "licensed treatment", "existing landscape professionals", "View Sample Assessment", "SDPP-Commercial-Palm-Stewardship.pdf", "View Commercial Overview", "Download Commercial Overview", "Request a Property Walkthrough"],
