...
async function main() {
  ...
  const requiredByPage = {
    "index.html": ["California Qualified Applicator License No. 175295", "Category B — Landscape Maintenance", "Insured", "Owner-led stewardship for valuable palm portfolios.", "Our goal is to preserve the value of your mature landscape assets.", "Identity &amp; baselines", "Stewardship &amp; Palm Health", "Protection &amp; Treatment", "Documentation &amp; Portfolio Management", "Response, Removal &amp; Renewal", "Request a Property Walkthrough", "Residential &amp; Estate Properties", "treatment and work history", "budgeting support"],
    "managed-property-palm-services.html": ["Palm Portfolio Stewardship for Managed Properties", "Our goal is to preserve the value of your mature landscape assets.", "Treatment is one tool. Stewardship is the ongoing model.", "What SDPP takes responsibility for", "Stewardship &amp; Palm Health", "Protection &amp; Treatment", "Documentation &amp; Portfolio Management", "Response, Removal &amp; Renewal", "Palm asset register", "Baseline condition record", "Recurring stewardship plan", "Dated visit and treatment records", "Material-change alerts", "Periodic portfolio summary", "Palm Portfolio Baseline", "Annual Palm Stewardship Program", "data-engagement-path=\"palm-portfolio-baseline\"", "data-engagement-path=\"annual-palm-stewardship-program\"", "licensed treatment", "Request a Property Walkthrough", "existing landscapers", "SDPP-Commercial-Palm-Stewardship.pdf", "View Commercial Overview", "Download Commercial Overview"],
    "palm-records-monitoring-verification.html": ["id=\"homeowner-inquiry\"", "id=\"organization-inquiry\"", "For commercial and managed properties", "Request a Property Walkthrough", "known_palm_species", "existing_contractor", "desired_service", "preferred_contact"],
