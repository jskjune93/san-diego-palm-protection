...
async function main() {
  ...
  if (routes.length !== 49) throw new Error(`Expected 49 HTML routes after adding the new Palm Journal article, found ${routes.length}`);
  ...
  const requiredByPage = {
    "index.html": ["California Qualified Applicator License No. 175295", "Category B — Landscape Maintenance", "Insured", "Preventive Treatment for San Diego’s Most Valuable Palms", "licensed preventive treatment", "mature Canary Island date palms", "Request a Palm Assessment", "Field Work", "San Diego Botanic Garden called. I was there the next day.", "active South American palm weevil infestation", "Chilean wine palms, Canary Island date palms, and Sylvester palms", "The landscapes worth protecting."],
    "palm-records-monitoring-verification.html": ["Protect valuable palms from SAPW", "Treatment is what SDPP does", "Preventive SAPW treatment", "Coordinating removals", "Coordinating replacements", "Other palm goals", "id=\"homeowner-inquiry\"", "id=\"organization-inquiry\"", "For commercial and managed properties", "Request a Baseline", "known_palm_species", "existing_contractor", "desired_service", "preferred_contact"],
    "palm-stewardship-plans.html": ["Protection and treatment services are available"],
    "quarterly-palm-care-san-diego.html": ["Annual Mature Palm Protection Program", "every three months", "preventive SAPW treatment", "Four visits each year", "Priority response"],
