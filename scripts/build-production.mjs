...
async function main() {
  ...
  const requiredByPage = {
    "index.html": ["California Qualified Applicator License No. 175295", "Category B — Landscape Maintenance", "Insured", "South American Palm Weevil Protection for San Diego’s Mature Palms", "licensed preventive treatment", "mature Canary Island date palms", "Request a Palm Assessment", "View Field Work", "San Diego Botanic Garden called. I was there the next day.", "active South American palm weevil infestation", "Chilean wine palms, Canary Island date palms, and Sylvester palms", "See the work behind the service."],
    "palm-records-monitoring-verification.html": ["SAPW prevention and licensed palm treatment", "Licensed SAPW prevention and treatment", "Assessments &amp; baselines", "Recurring palm care", "Decline, recovery &amp; transplant care", "Sourcing, re-homing &amp; coordination", "id=\"homeowner-inquiry\"", "id=\"organization-inquiry\"", "For commercial and managed properties", "Request a Baseline", "known_palm_species", "existing_contractor", "desired_service", "preferred_contact"],
