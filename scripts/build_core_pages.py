...
PAGES: dict[str, dict] = {
    "index.html": {
        ...
        "body": section("Primary service", "Protect mature palms before visible collapse.", "South American palm weevil can cause advanced damage before a crown fails. SDPP provides licensed preventive treatment for mature Canary Island date palms and other appropriate high-value specimens.", '<div class="field-split"><figure><img src="./images/old-escondido-ufmp/healthy-private-yard-cidp.jpg" alt="Healthy mature Canary Island date palm photographed by SDPP in Old Escondido" loading="lazy" decoding="async"><figcaption class="image-caption">A mature Canary Island date palm in Old Escondido.</figcaption></figure><div class="luxury-copy"><p class="display-line">Early protection preserves more options.</p><ul class="clean-list"><li>Site-specific licensed treatment</li><li>Recurring protection and monitoring</li><li>Direct service from owner John Krause</li></ul><a class="text-arrow" href="./south-american-palm-weevil-treatment-san-diego.html">Explore SAPW treatment</a></div></div>') +
        section("Beyond treatment", "Complete care for valuable palm assets.", "For estates, luxury landscapes, HOAs, institutions, and managed properties.", cards([("Assessments", "A clear on-site review with practical recommendations."),("Recurring care", "Scheduled treatment, monitoring, and follow-up."),("Decline & recovery", "Rapid response for changing or transplanted palms."),("Sourcing & coordination", "Specimen guidance and qualified-contractor coordination.")]), "section-tint") +
        ...
        section("Local evidence", "See the work behind the service.", "Field Work and the Palm Journal carry the photographs, video, local SAPW history, and palm-loss record.", '<div class="field-split field-split--reverse"><figure><img src="./images/old-escondido-ufmp/owner-documented-multiple-sapw-captures.jpg" alt="Adult South American palm weevils photographed by John Krause in Old Escondido" loading="lazy" decoding="async"><figcaption class="image-caption">Adult SAPW photographed in Old Escondido.</figcaption></figure><div class="field-links"><a href="./palm-proof-examples.html">View Field Work</a><a href="./palm-journal-new.html">Palm Journal</a><a href="./palm-journal/documented-loss/">Palm Loss Record</a></div></div>'),
    },
    "about.html": {
...
<p>That is palm stewardship.</p>
  ...
  <div class="residential-proof-inline__links"><a href="./old-escondido-urban-forest-documentation.pdf" target="_blank" rel="noopener noreferrer">View the PDF <span class="sr-only">(opens in a new tab)</span></a><a href="./palm-proof-examples.html">More field work</a></div>
    ...
    "palm-records-monitoring-verification.html": {
        ...
        "body": section("Primary service", "Licensed SAPW prevention and treatment.", "Protect mature Canary Island date palms and other appropriate high-value specimens before advanced decline.", '<div class="field-split"><figure><img src="./images/old-escondido-ufmp/john-krause-with-mature-cidp.jpg" alt="John Krause with a mature Canary Island date palm in Old Escondido" loading="lazy" decoding="async"><figcaption class="image-caption">Owner John Krause with a mature CIDP.</figcaption></figure><div class="luxury-copy"><ul class="clean-list"><li>Preventive and responsive licensed treatment</li><li>Site-specific plans within label and legal requirements</li><li>Recurring protection, monitoring, and treatment history</li><li>Direct owner-led service</li></ul></div></div>') +
        section("Ancillary services", "Everything needed around the treatment.", "Straightforward support for valuable palms and luxury landscapes.", '<div class="service-lines"><article><h3>Assessments &amp; baselines</h3><p>On-site review, palm identification, photographs, and recommendations.</p></article><article><h3>Recurring palm care</h3><p>Scheduled visits, treatment history, condition tracking, and follow-up.</p></article><article><h3>Decline, recovery &amp; transplant care</h3><p>Rapid-change review, establishment concerns, and recovery monitoring.</p></article><article><h3>Sourcing, re-homing &amp; coordination</h3><p>Specimen review and coordination with independent qualified contractors.</p></article></div>', "section-tint") +
