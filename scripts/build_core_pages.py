...
PAGES: dict[str, dict] = {
    "index.html": {
        ...
        "eyebrow": "South American Palm Weevil Protection · Owner-led",
        "h1": "Protecting San Diego’s Most Valuable Palms",
        "lede": "Licensed South American palm weevil prevention, treatment, and recurring care for mature palms across San Diego County.",
...
<p>That is palm stewardship.</p>
  ...
  <div class="residential-proof-inline__links"><a href="./old-escondido-urban-forest-documentation.pdf" target="_blank" rel="noopener noreferrer">View the PDF <span class="sr-only">(opens in a new tab)</span></a><a href="./palm-proof-examples.html">More field work</a></div>
    ...
    "palm-records-monitoring-verification.html": {
        ...
        section("Ancillary services", "Everything needed around the treatment.", "Straightforward support for valuable palms and luxury landscapes.", '<div class="service-lines"><article><h3>Assessments &amp; baselines</h3><p>On-site review, palm identification, photographs, and recommendations.</p></article><article><h3>Recurring palm care</h3><p>Scheduled visits, treatment history, condition tracking, and follow-up.</p></article><article><h3>Decline, recovery &amp; transplant care</h3><p>Rapid-change review, establishment concerns, and recovery monitoring.</p></article><article><h3>Sourcing, re-homing &amp; coordination</h3><p>Specimen review and coordination with independent qualified contractors.</p></article></div><div class="service-image-band" aria-label="Palm landscapes photographed by SDPP"><img src="./images/luxury-landscapes/palm-lined-estate-court.webp" alt="Palm-lined San Diego County landscape" loading="lazy" decoding="async"><img src="./images/luxury-landscapes/garden-color-and-palms.webp" alt="Colorful garden with palms" loading="lazy" decoding="async"><img src="./images/old-escondido-ufmp/old-home-mature-cidps-golden-hour.jpg" alt="Mature Canary Island date palms at golden hour in Old Escondido" loading="lazy" decoding="async"></div>', "section-tint") +
