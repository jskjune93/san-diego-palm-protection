...
PAGES: dict[str, dict] = {
    "index.html": {
        ...
        section("Owner-led palm portfolio stewardship", "Ongoing responsibility, not isolated transactions.", "The portfolio is the unit of responsibility. Depending on the agreed scope, stewardship connects inventory, condition records, preservation priorities, recurring care, licensed treatment, work history, budgeting support, and the next responsible action when conditions change.", three_pillars()) +
        ...
        section("Ongoing stewardship", "Know each priority palm, its history, and what needs attention next.", "Documentation supports the care. It connects current condition, treatment and work history, recurring priorities, and the next responsible decision.", process([
            ("Understand", "Identify the palms, visible conditions, site needs, access, and relevant history."),
            ("Care", "Set priorities for health observation, fertilization, irrigation guidance, preventive protection, treatment, and return visits."),
            ("Record", "Maintain useful photographs, condition notes, treatment and work histories, and portfolio priorities."),
            ("Respond", "Coordinate the next step when decline, contractor work, removal, replacement, or another specialist becomes relevant."),
        ...
        section("Scope and pricing", "The scope follows the property and responsibility.", "Palm count, condition, access, treatment requirements, visit frequency, coordination needs, and the records required all affect the work and price.", '<p class="note">I will confirm the agreed scope and price before the work begins.</p>') +
...
<div class="about-john-story">
  ...
  <div class="about-john-marks">
    ...
    "managed-property-palm-services.html": {
        ...
        section("Existing property teams", "SDPP does not need to replace the landscape team.", "The stewardship role creates continuity around the palms, maintains the record, performs agreed licensed work, and coordinates specialized action when needed. I can work alongside existing landscapers, arborists, tree companies, plant-health providers, and other qualified contractors.", '<p class="note">Coordination does not imply supervision or contractual authority over another professional. I cannot verify work hidden from view or certify workmanship, structural safety, code compliance, pesticide efficacy, contractor licensing, or outcomes.</p>', "section-tint") +
