...
PAGES: dict[str, dict] = {
    "index.html": {
        ...
        section("Local evidence", "See the work behind the service.", "Field Work and the Palm Journal carry the photographs, video, local SAPW history, and palm-loss record.", '<div class="field-split field-split--reverse"><figure><img src="./images/old-escondido-ufmp/old-home-mature-cidps-golden-hour.jpg" alt="Mature Canary Island date palms beside an Old Escondido home at golden hour" loading="lazy" decoding="async"><figcaption class="image-caption">Mature Canary Island date palms at golden hour in Old Escondido.</figcaption></figure><div class="field-links"><a href="./palm-proof-examples.html">View Field Work</a><a href="./palm-journal-new.html">Palm Journal</a><a href="./palm-journal/documented-loss/">Palm Loss Record</a></div></div>'),
    },
    "about.html": {
