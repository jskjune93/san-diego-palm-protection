...
PAGES: dict[str, dict] = {
    "index.html": {
        ...
        section("Trusted with significant palms", "Treatment at San Diego Botanic Garden.", "On August 22, 2026, SDPP provided an initial on-site assessment and licensed treatment of multiple high-value specimen palms at San Diego Botanic Garden, including Chilean wine palms, Canary Island date palms, and Sylvester palms.", '<p class="note">This service record documents the visit and treated palm groups. It does not state or imply Garden endorsement, elimination of a pest, or a guaranteed outcome.</p>') +
