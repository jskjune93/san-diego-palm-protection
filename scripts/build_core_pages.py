...
def sapw_visual_guide() -> str:
    return '''<section class="section sapw-photo-guide" id="weevil-photos" aria-labelledby="weevil-photos-heading">
  <div class="section-intro"><p class="eyebrow">Photographed in Old Escondido</p><h2 id="weevil-photos-heading">Meet the weevil.</h2><p>These are adults I captured and photographed at my own property. The close-up shows the long snout, dark body, and legs clearly.</p></div>
  <nav class="sapw-guide-nav" aria-label="Palm weevil field guide"><a href="#weevil-photos">Weevil photos</a><a href="#palm-damage">Decline and loss</a><a href="#palm-next-step">What to do next</a></nav>
  <div class="sapw-specimen-grid">
    <figure><a href="./images/palm-journal/when-sapw-became-local/01-june-15-adult-sapw.jpg" aria-label="Open full-size adult palm weevil close-up"><img src="./images/palm-journal/when-sapw-became-local/01-june-15-adult-sapw.jpg" alt="Side view of a captured adult South American palm weevil, showing its long snout and black body" width="1800" height="1080" loading="lazy" decoding="async"></a><figcaption><strong>The adult, up close.</strong> Photographed after capture in Old Escondido on June 15, 2026. Select a photo to see the full-size image.</figcaption></figure>
    <figure><a href="./images/palm-journal/when-sapw-became-local/03-june-16-six-captured-adults.jpg" aria-label="Open full-size photo of six captured palm weevils"><img src="./images/palm-journal/when-sapw-became-local/03-june-16-six-captured-adults.jpg" alt="Six captured adult palm weevils arranged in three rows for an Old Escondido field record" width="1800" height="1692" loading="lazy" decoding="async"></a><figcaption><strong>Six adults in one record.</strong> Photographed on June 16, 2026. These are owner-documented captures, not a laboratory identification report.</figcaption></figure>
  </div>
  <p class="section-proof-link"><a href="./palm-journal/when-sapw-became-local.html">Read the dated capture record and watch the adult moving on a palm trunk</a></p>
</section>
<section class="section section-tint" id="palm-damage" aria-labelledby="palm-damage-heading">
  <div class="section-intro"><p class="eyebrow">From crown decline to an empty place</p><h2 id="palm-damage-heading">What losing a mature palm looks like.</h2><p>South American palm weevil larvae feed inside a palm. Damage to the growing point can kill a Canary Island date palm, and an infestation can be missed until severe damage has occurred. <a href="https://ipm.ucanr.edu/home-and-landscape/giant-palm-weevils/">UC IPM explains the damage and warning signs.</a></p></div>
  <p class="sapw-case-note">The photographs below show one documented palm at Las Palmas in Old Escondido: visible crown decline, a closer view, and the stump after removal. SAPW was suspected in this record; the photographs alone do not confirm the cause.</p>
  <div class="sapw-damage-sequence">
    <figure><a href="./images/las-palmas/04-exact-subject-20260710-193355.jpg" aria-label="Open full-size view of the Las Palmas palm before removal"><img src="./images/las-palmas/04-exact-subject-20260710-193355.jpg" alt="Canary Island date palm at Las Palmas before removal, with green outer fronds and declining central growth" width="3000" height="4000" loading="lazy" decoding="async"></a><figcaption><span class="eyebrow">01 / The whole palm</span><strong>Green fronds can hide the concern.</strong> The outer canopy still carries green fronds while the center looks different.</figcaption></figure>
    <figure><a href="./images/las-palmas/09-severe-decline-2026-07-10-las-palmas-declining-palm-central-frond-necrosis-detail-03.jpg" aria-label="Open full-size close-up of declining central fronds"><img src="./images/las-palmas/09-severe-decline-2026-07-10-las-palmas-declining-palm-central-frond-necrosis-detail-03.jpg" alt="Close view of brown and failing central fronds on the same Las Palmas Canary Island date palm" width="3000" height="4000" loading="lazy" decoding="async"></a><figcaption><span class="eyebrow">02 / A closer look</span><strong>The center tells a different story.</strong> This detail preserves the visible browning and deterioration in the crown.</figcaption></figure>
    <figure><a href="./images/las-palmas/12-stump-20260713-184911.jpg" aria-label="Open full-size view of the stump after palm removal"><img src="./images/las-palmas/12-stump-20260713-184911.jpg" alt="Fresh stump on the sloped bed where the documented Las Palmas palm stood" width="3000" height="4000" loading="lazy" decoding="async"></a><figcaption><span class="eyebrow">03 / After removal</span><strong>The palm is gone.</strong> The stump records the loss of the mature palm from this landscape.</figcaption></figure>
  </div>
  <p class="section-proof-link"><a href="./palm-journal/las-palmas-no-reply-then-the-saws.html">See the complete Las Palmas photo sequence</a> · <a href="./palm-journal/documented-loss/">Explore the Palm Loss Record</a></p>
</section>
<section class="section" id="palm-next-step" aria-labelledby="palm-next-step-heading">
  <div class="section-intro"><p class="eyebrow">A concern about your palm</p><h2 id="palm-next-step-heading">Get the palm looked at before the picture gets worse.</h2><p>Tell me your city, what changed, and any treatment history you know. I can look at the palm, document its condition, and explain the protection or response options that fit.</p></div>
  <div class="button-row"><a class="button" data-conversion="homeowner-inquiry-initiation" href="./palm-records-monitoring-verification.html#homeowner-inquiry">Request a Palm Assessment</a><a class="button button-quiet" href="./south-american-palm-weevil-treatment-san-diego.html">Prevention &amp; treatment options</a><a class="text-link" data-conversion="call" href="tel:2624923135">Call or Text 262-492-3135</a></div>
</section>'''
...
PAGES: dict[str, dict] = {
    "index.html": {
        ...
        "eyebrow": "Palm protection specialist · Old Escondido",
        "h1": "Preventive Treatment for San Diego’s Most Valuable Palms",
        "lede": "I’m John Krause, based in Old Escondido. I specialize in licensed preventive treatment for South American palm weevil (SAPW), caring for mature Canary Island date palms and other appropriate specimens across San Diego County.",
        ...
        section("Palm landscapes", "The landscapes worth protecting.", "A selection of San Diego County palms and gardens photographed by SDPP.", '<div class="visual-gallery" aria-label="Palm landscape gallery"><figure class="visual-gallery__feature"><img src="./canary-island-date-palm-mansion-poway.jpg" alt="Mature Canary Island date palms in a Poway estate landscape" loading="lazy" decoding="async"></figure><figure><img src="./healthy-canary-island-date-palm-in-rancho-santa-fe-san-diego-palm-protection.jpg" alt="Mature palms along a Rancho Santa Fe landscape" loading="lazy" decoding="async"></figure><figure><img src="./images/luxury-landscapes/coastal-palm-landscape.webp" alt="Palm-rich coastal San Diego County landscape photographed by SDPP" loading="lazy" decoding="async"></figure><figure><img src="./mature-CIDP-Escondido-estate.jpg" alt="Mature Canary Island date palms in an Escondido estate landscape" loading="lazy" decoding="async"></figure></div><div class="gallery-links"><a class="text-arrow" href="./palm-proof-examples.html">Field Work</a><a class="text-arrow" href="./palm-journal-new.html">Palm Journal</a></div>', "gallery-section"),
    },
    "about.html": {
...
<p>That is palm stewardship.</p>
  ...
  <div class="residential-proof-inline__links"><a href="./old-escondido-urban-forest-documentation.pdf" target="_blank" rel="noopener noreferrer">View the PDF <span class="sr-only">(opens in a new tab)</span></a><a href="./palm-proof-examples.html">More field work</a></div>
    ...
    "palm-records-monitoring-verification.html": {
        ...
        "eyebrow": "Annual preventive treatment in San Diego County", "h1": "Protect valuable palms from SAPW.",
        "lede": "The Annual Mature Palm Protection Program keeps preventive South American palm weevil treatment on schedule throughout the year.",
        "image": "mature-cidp-estate.jpg",
        "body": section("Annual Mature Palm Protection Program", "Treatment is what SDPP does.", "I make four scheduled visits each year to treat your palms, check for visible changes, and keep their photographs and service records up to date.", '<div class="field-split"><figure><img src="./images/old-escondido-ufmp/john-krause-with-mature-cidp.jpg" alt="John Krause with a mature Canary Island date palm in Old Escondido" loading="lazy" decoding="async"><figcaption class="image-caption">Owner and Qualified Applicator John Krause.</figcaption></figure><div class="luxury-copy"><ul class="clean-list"><li>Four scheduled visits per year</li><li>Preventive SAPW treatment by a licensed Qualified Applicator</li><li>Visual health and infestation review</li><li>Repeat photographs and service records</li><li>SDPP scheduling reminders</li><li>Priority response when symptoms appear</li></ul></div></div>') +
        section("Additional help", "Sometimes clients need more.", "When needs extend beyond treatment, SDPP may help coordinate the next step.", '<div class="service-lines"><article><h3>Coordinating removals</h3><p>Connecting clients with qualified removal contractors.</p></article><article><h3>Coordinating replacements</h3><p>Helping organize specimen selection, sourcing, and installation.</p></article><article><h3>Other palm goals</h3><p>Practical guidance and coordination when the need falls outside treatment.</p></article></div><div class="service-image-band" aria-label="Palm landscapes photographed by SDPP"><img src="./healthy-canary-island-date-palm-in-rancho-santa-fe-san-diego-palm-protection.jpg" alt="Mature palms along a Rancho Santa Fe landscape" loading="lazy" decoding="async"><img src="./two-statement-cidp-mansion-poway.jpg" alt="Mature Canary Island date palms in a Poway estate landscape" loading="lazy" decoding="async"><img src="./images/luxury-landscapes/coastal-palm-landscape.webp" alt="Palm-rich coastal San Diego County landscape" loading="lazy" decoding="async"></div>', "section-tint") +
        section("One clear program", "Annual protection, sized to the property.", "The same preventive-treatment relationship serves homeowners, estates, HOAs, institutions, and selected managed properties.", '<div class="audience-grid audience-grid--2"><article class="audience-card" data-engagement-path="palm-portfolio-baseline"><h3>Annual Mature Palm Protection Program</h3><p>Four scheduled visits for one mature palm or a small residential group.</p></article><article class="audience-card" data-engagement-path="annual-palm-stewardship-program"><h3>Managed-property protection</h3><p>The annual program scaled to an agreed portfolio of valuable palms.</p></article></div><p><a href="./SDPP-Commercial-Palm-Stewardship.pdf" target="_blank" rel="noopener noreferrer">View Commercial Overview <span class="sr-only">(PDF, opens in a new tab)</span></a> · <a href="./SDPP-Commercial-Palm-Stewardship.pdf" download>Download Commercial Overview</a></p>') +
    ...
    "quarterly-palm-care-san-diego.html": {
        ...
        "body": section("Four visits each year", "Protection stays on the calendar.", "Each scheduled visit keeps preventive treatment and the palm's visible condition connected over time.", process([
            ("Review", "Inspect the palm for visible health changes and signs that may require a different response."),
            ("Treat", "Perform the scheduled preventive SAPW treatment within label, legal, site, and agreed-scope requirements."),
            ("Record", "Add repeat photographs and the completed service to the palm's history."),
            ("Schedule", "Set the next visit and keep the reminder with SDPP."),
        ])) + section("Built for valuable palms", "Simple for the owner. Consistent for the palm.", "The program is designed for mature Canary Island date palms and other appropriate high-value specimens where recurring preventive protection is warranted.", cards([
...
<div class="sample-assessment-grid">
  ...
  <aside class="sample-document-card" aria-label="Sanitized mature palm documentation example PDF">
    ...
    "south-american-palm-weevil-treatment-san-diego.html": {
        ...
        section("Questions before treatment", "Straight answers about SAPW treatment.", "The palm, site, treatment history, and pesticide label determine the recommendation. These are the questions I hear most often.", '<div class="faq-list"><details><summary>Can you treat a Canary Island date palm that still looks healthy?</summary><p>Yes. Preventive protection is most useful before obvious crown failure. I first review the palm, site, known local pressure, access, and treatment history to decide whether treatment is appropriate.</p></details><details><summary>How often does preventive SAPW treatment need to be applied?</summary><p>There is no responsible one-size-fits-all interval. UC guidance notes that preventive protection may require three to four treatments per year. SDPP offers four scheduled visits through the <a href="./quarterly-palm-care-san-diego.html">Annual Mature Palm Protection Program</a>, but the actual product, route, timing, and legal use must follow the label and fit the palm and site.</p></details><details><summary>What SAPW treatment methods are available?</summary><p>Management may use soil-applied systemic treatment, a label-approved trunk or basal route, crown treatment, or a combined response. Uptake speed, residual period, palm height, irrigation, slope, weather, access, and crown condition all matter. The <a href="./output/pdf/sdpp-sapw-prevention-management-guide.pdf">SDPP prevention and management guide</a> compares the approaches.</p></details><details><summary>How much does palm weevil treatment cost in San Diego?</summary><p>Cost depends on the number and size of the palms, access, treatment route, site conditions, and whether the work is preventive or responding to visible decline. I assess the actual palm and scope before quoting the work rather than publishing a price that may not fit the property.</p></details><details><summary>What happens at the first visit?</summary><p>I look at the palm and site, take dated photographs, review the history you can provide, and explain the next steps. Treatment depends on the findings, applicable label, access, and agreed scope.</p></details><details><summary>Can a declining palm always be saved?</summary><p>No. Visible decline can have different causes, and treatment cannot guarantee recovery. Once the growing point is badly damaged or the palm may be unstable, urgent evaluation and removal coordination may be more responsible than treatment.</p></details><details><summary>What warning signs deserve a prompt assessment?</summary><p>New browning or failure in the center of the crown, a flattened or asymmetric crown, rapid change, frass, odor, holes, pupal cases, or adult weevils deserve attention. None of those signs alone confirms SAPW. See the <a href="./sapw.html">local SAPW photographs and warning signs</a>.</p></details></div><p><a class="button" data-conversion="homeowner-inquiry-initiation" href="./palm-records-monitoring-verification.html#homeowner-inquiry">Request a Palm Assessment</a></p>') +
        section("Local evidence", "What this work looks like in San Diego County.", "These field notes show the pest, the palms, and preventive treatment through photographs from my own work.", '<div class="service-grid service-grid--3"><article class="service-card"><h3>Treatment visits</h3><p><a href="./palm-journal/september-treatment-day.html">See mature palms under preventive treatment</a>.</p></article><article class="service-card"><h3>When SAPW became local</h3><p><a href="./palm-journal/when-sapw-became-local.html">See dated adult-weevil photographs and video from Old Escondido</a>.</p></article><article class="service-card"><h3>Why local continuity matters</h3><p><a href="./palm-journal/local-is-the-point.html">Read why I stay close to the palms between visits</a>.</p></article></div>', "section-tint") +
